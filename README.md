...
[![CI](https://github.com/jolars/badness-action/actions/workflows/ci.yml/badge.svg)](https://github.com/jolars/badness-action/actions/workflows/ci.yml)

A GitHub Action that installs [badness](https://github.com/jolars/badness) and
runs formatting and lint checks on LaTeX sources in CI.
...
Add `--signer-workflow jolars/badness/.github/workflows/packages.yml` to also
